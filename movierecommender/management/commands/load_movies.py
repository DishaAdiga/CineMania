...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        #1.Iterate over movies.csv file
        #2.Get each movie row
        #3.Populate objects of Movie db
        #4.Call the save method to store data in movie db
...
#python manage.py load_movies --path movies.csv in cmd to load all movies